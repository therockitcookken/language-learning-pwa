  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/75 border border-slate-800/80 rounded-3xl p-5 space-y-2.5 shadow-xl backdrop-blur-xl relative overflow-hidden double-bezel">
        ...
        <div className="bg-slate-900/75 border border-slate-800/80 rounded-3xl p-5 space-y-2.5 shadow-xl backdrop-blur-xl double-bezel">
          <div className="flex items-center justify-between">
        ...
        <div className="bg-slate-900/75 border border-slate-800/80 rounded-3xl p-5 space-y-2.5 shadow-xl backdrop-blur-xl flex items-center gap-3.5 double-bezel">
      ...
      <div className="bg-slate-900/75 border border-slate-800/80 rounded-3xl p-6 shadow-2xl backdrop-blur-xl space-y-5 double-bezel">
        <div className="flex items-center justify-between">
          <div>
