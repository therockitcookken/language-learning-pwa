...
function main() {
  console.log("Starting Fast Verified English Vocabulary Pipeline...");
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Authentic synonyms/antonyms from frequency list or curated maps
    ...
    if (accepted.length >= 20000) {
      console.log("Reached target of 20,000 verified English words.");
      break;
    }
  }
  ...
  console.log("-----------------------------------------");
  console.log("FAST VERIFIED ENGLISH PIPELINE COMPLETED");
