...
async function testFetchZh() {
  const sources = [
    { url: 'https://raw.githubusercontent.com/pwxcoo/chinese-xinhuazidian/master/data/word.json', file: 'xinhua_words.json' },
    { url: 'https://raw.githubusercontent.com/pwxcoo/chinese-xinhuazidian/master/data/ci.json', file: 'xinhua_ci.json' }
  ];
